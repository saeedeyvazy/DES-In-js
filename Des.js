...
export function des(do_encrypt, data, key) {
...
function do_tdes(do_encrypt) {
  ...
  // get the message from the user
  // also check if it is ASCII or hex
  get_value(inData, "072351E35AB8B99C", false);
  ...
  get_value(KeyA, "1C1C1C1C1C1C1C1C", false);
  // problems??
  if (KeyA[0] == ERROR_VAL) {
    // document.stuff.details.value = accumulated_output_info;
    return;
